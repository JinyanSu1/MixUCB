...
T=200
FILE=simulation_data_toy20241009_noise0.2.pkl
# variable params
# BETA=4000
python run_linucb.py --pickle_file $FILE --lambda $LAMBDA --alpha $ALPHA --T $T
python run_noisy_expert.py --pickle_file $FILE --temperature $TEMPERATURE --T $T
python run_perfect_expert.py --pickle_file $FILE --T $T
