...
import torch
import pickle
from utils.run_simulation import CBOptimizationDPP, solve_convex_optimization_ucb, solve_convex_optimization_lcb
...
if __name__ == "__main__":
    ...
    parser.add_argument('--beta_MixUCBI', type=float, default=100)
